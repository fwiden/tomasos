...
namespace Webshop.Models
{
    ...
    public partial class TomasosConn : DbContext
    {
        public TomasosConn()
            : base("name=TomasosConn")
        {
        }
        ...
        public virtual ObjectResult<GetMeny_Result> GetMeny()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetMeny_Result>("GetMeny");
        }
